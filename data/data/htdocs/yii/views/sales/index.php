    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute' => 'name', 'label' => 'Название', 'value' => function($model) {
                return $model->ticket->tourDate->tour->name;
            }],
            ['attribute' => 'date_tour', 'label' => 'Дата', 'value' => function($model) {
                return $model->ticket->tourDate->date_tour;
            },
            ...
            ['attribute' => 'username', 'label' => 'Гость', 'value' => function($model) {
                return $model->ticket->guest->username;
            }],
            'summ',
            [
