...
/** @var app\models\UserAttrSearch $searchModel */
...
<div class="user-attr-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute' => 'username', 'label' => 'Логин', 'value' => function($model) {
                return $model->user->username;
            }],
            ['attribute' => 'role', 'label' => 'Роль', 'value' => function($model) {
                return $model->user->role1->role;
            }],
            'fio',
            'phone',
            'email:email',
...
//            'registr',
            [
                ...
                'urlCreator' => function ($action, UserAttr $model, $key, $index, $column) {
